...
export default function LMS() {
   return(
      <section className="flex flex-col xl:flex-row items-center gap-6 xl:gap-20 bg-[#5712441A] p-6 xl:py-12 xl:px-16">
         {/* Heading for mobile */}
         <div className="flex xl:hidden w-full justify-start">
         ...
         <div className="flex flex-col xl:gap-8">
            <div className="flex flex-col gap-5">
               {/* Heading for Laptop */}
               <div className="hidden xl:flex w-full justify-start">
                  <h1 className="text-[#571244] text-[40px] text-nowrap  font-nunito font-semibold">Learning Management System</h1>
               </div>
               <div className="flex flex-col rounded-lg gap-6 bg-[#5712441A] p-6 xl:gap-5">
                  ...
                  <div className="flex flex-col gap-3">
                     <h3 className="text-[#571244] text-base text-nowrap font-nunitosan font-bold">Some of our courses include:</h3>
                     <ul className="flex flex-col xl:grid xl:grid-cols-3 gap-3 list-disc pl-5 text-sm xl:text-base font-nunitosan">
                 ...
                 <div className="flex xl:hidden"><LearnMore/></div>
               </div>
            </div>

            {/* Learn More Button For Laptop */}
            <div className="xl:flex hidden"><LearnMore/></div>
         </div>
      </section>
   )
}